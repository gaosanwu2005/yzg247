!function (t) {
    ...
    i.DEFAULTS = {
        ...
        var i = this, n = i.options, o = t.location;
        ...
        var t = this, i = t.options, n = $(i.binder), o = e.sessionStorage.get(t.backParamsKey);
        o && n.stop().animate({scrollTop: o.offsetTop}, 0, function () {
            t.scrolling = !1
        ...
        t.loading = !0, t.$loading.show(), "function" == typeof i.loadListFn && i.loadListFn().done(function (n, o) {
            ...
            a < i.pageSize && (t.$element.append('<div class="list-donetip">' + i.doneTxt + "</div>"), t.isDone = !0), t.$loading.hide(), t.loading = !1, i.backposition && e.sessionStorage.set(t.backParamsListKey + o, n)
        })
    }, i.prototype.loadListFromStorage = function () {
        var t = this, i = e.sessionStorage.get(t.backParamsKey);
        if (i) {
            e.pageScroll.lock();
    ...
    function a(t) {
        ...
        return this.each(function () {
            var i = $(this), n = i.data("ydui.keyboard");
    ...
    o.DEFAULTS = {disorder: !1, title: "安全键盘"}, o.prototype.init = function () {
        function e() {
        ...
        var t = this, i = t.$element, n = t.$numsBox;
    ...
    var e = $(t.document.body);
    i.DEFAULTS = {provance: "", city: "", area: ""}, i.prototype.init = function () {
        var t = this, e = t.options;
        if ("undefined" == typeof YDUI_CITYS) return void console.error("请在ydui.js前引入ydui.citys.js。下载地址：http://cityselect.ydui.org");
        t.citys = YDUI_CITYS, t.createDOM(), t.defaultSet = {provance: e.provance, city: e.city, area: e.area}
    }, i.prototype.open = function () {
        var t = this;
        e.append(t.$mask), YDUI.device.isMozilla && t.$element.blur(), t.$mask.on("click.ydui.cityselect.mask", function () {
            t.close()
        });
        var i = t.$cityElement, n = t.defaultSet;
    ...
    e.DEFAULTS = {
        ...
        $.each(i, function (i, n) {
            ...
            if (a) o = a, t.isNumber(a) || "function" == typeof(o = e[n.param]) && (o = o()); else if ("function" == typeof e[n.param]) {
                var r = e[n.param]();
        ...
        /^(([1-9]\d*)|0)$/.test(t) || (t = n), t > n && 0 != n && (t = n), t % o > 0 && (t = t - t % o + o) > n && 0 != n && (t -= o), t < a && (t = a - a % o), e.$input.val(t), "function" == typeof i.callback && i.callback(t, e.$input)
    }, e.prototype.bindEvent = function () {
    ...
    e.DEFAULTS = {
        ...
        if (setTimeout(function () {
            ...
            n.moveTag = 0;
            Date.now() - n.touchStartTime > 300 && Math.abs(o) <= .5 * t.$wrapper.width() ? t.setTranslate(e, -t.index * t.$wrapper.width()) : t.setTranslate(e, -(o > 0 ? --t.index : ++t.index) * i), t.autoPlay()
        }
    ...
    i.confirm = function (t, i, o) {
        ...
        return function (i, o, a, r) {
            clearTimeout(t);
            var s = "YDUI_TOAST";
            if ($("#" + s).remove(), arguments.length < 2) return void console.error("From YDUI's toast: Please set two or more parameters!!!");
            var l = "";
    ...
    function r(t) {
        var e = Array.prototype.slice.call(arguments, 1);
        return this.each(function () {
            var i = $(this), a = i.data("ydui.progressbar");
    ...
    var e = t.document, i = t.YDUI.util;
    n.prototype = new a, n.prototype.getPathString = function (t) {
        ...
        var t = this, i = t.options, n = e.createElementNS("http://www.w3.org/2000/svg", "svg");
        t.initSvg(n, i);
    ...
    a.prototype.open = function () {
        ...
        e.preventDefault();
        var i = t.YDUI.util.parseOptions($(this).data("ydui-actionsheet")), n = $(i.target),
    ...
    e.TRANSITION_DURATION = 150, e.DEFAULTS = {
        ...
        var o = this, a = o.options.activeClass, r = i.filter("." + a);
    ...
    t.prototype.needsClick = function (t) {
        ...
        return !(!n || o || !(c = u.fastClickScrollParent) || c.fastClickLastScrollTop === c.scrollTop) || (this.needsClick(u) || (t.preventDefault(), this.sendClick(u, t)), !1)
