define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'trade2/ppmx2/index',
                    add_url: 'trade2/ppmx2/add',
                    edit_url: 'trade2/ppmx2/edit',
                    del_url: 'trade2/ppmx2/del',
                    multi_url: 'trade2/ppmx2/multi',
                    table: 'ppmx2',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'tsimg', title: __('Tsimg'), formatter: Table.api.formatter.image, events: Table.api.events.img},
